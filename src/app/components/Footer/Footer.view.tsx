        ...
        <div className="footer-body">
            <div className="footer-office">
                <div className="footer-office-info">
                    ...
                    <p className="footer-office-info-desc font-semibold">우리는 국가의 장벽을 넘어 최고의 인재를 매칭해드립니다.</p>
                </div>
                <div className="footer-office-info">
                    ...
                    renderBody={() => (
                        <Fragment>
                            <div className="flex flex-col gap-3">
                                ...
                                <p className="card-title font-semibold">외국인 원격 채용 <span className="font-bold">(비개발)</span></p>
                            </div>
                            <div className="card-action">
                                <p className="card-title font-semibold">바로가기</p>
                                <button className="card-action-button">
