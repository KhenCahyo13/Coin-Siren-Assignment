    ...
    <footer className="footer">
        <div className="footer-body">
            <div className="footer-office">
                <div className="footer-office-info">
                    <img src="/images/logo-original.png" alt="Nav Logo" className="footer-office-info-brand-img" />
                    <p className="footer-office-info-desc" style={{ fontWeight: 600 }}>우리는 국가의 장벽을 넘어 최고의 인재를 매칭해드립니다.</p>
                </div>
                <div className="footer-office-info">
                    <p className="footer-office-info-desc" style={{ fontWeight: 700 }}>010-0000-0000</p>
                    <p className="footer-office-info-desc" style={{ fontWeight: 700 }}>aaaaa@naver.com</p>
                </div>
            </div>
            {/* Card Collections */}
        ...
        <div className="footer-menus mt-8 lg:mt-12">
            ...
            <div className="footer-menu">
                ...
                <p className="footer-menu-subtitle-md">
        ...
        <p className="footer-copyright mt-8" style={{ fontWeight: 600 }}>&copy; 2023 Hyperhire</p>
    </footer>
);
