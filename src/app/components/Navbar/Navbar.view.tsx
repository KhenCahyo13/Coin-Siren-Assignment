        ...
        <div className={`${openNavbar ? 'flex' : 'hidden'} navbar-items`}>
            ...
            <div className="dropdown">
                ...
                <div className={`dropdown-items ${openDropdown ? 'block' : 'hidden'}`}>
                    <a href="#" className="dropdown-item dropdown-item-active">채용</a>
                    <a href="#" className="dropdown-item">해외 개발자 원격 채용</a>
                    <a href="#" className="dropdown-item">외국인 원격 채용 (비개발 직군)</a>
                    <a href="#" className="dropdown-item dropdown-item-last">한국어 가능 외국인 채용</a>
                </div>
            </div>
